(function(){
  ...
  var DISMISS_KEY = 'datakelas-install-dismissed-at';
  var DISMISS_DAYS = 7;
  ...
  function buildBanner(){
    ...
    el.setAttribute('aria-label', 'Pasang aplikasi DATA KELAS');
    el.innerHTML =
      ...
      '<div class="install-banner__body">' +
        '<p class="install-banner__title" id="install-banner-title">Pasang DATA KELAS di perangkat ini</p>' +
  ...
  function showBanner(variant){
    ...
    if(variant === 'ios'){
      bannerTitle.textContent = 'Pasang DATA KELAS di iPhone/iPad';
      ...
      bannerTitle.textContent = 'Pasang DATA KELAS di perangkat ini';
